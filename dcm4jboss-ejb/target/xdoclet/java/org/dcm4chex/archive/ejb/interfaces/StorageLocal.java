   ...
   extends javax.ejb.EJBLocalObject
{
   ...
   public org.dcm4che.data.Dataset store( org.dcm4che.data.Dataset ds,long fspk,java.lang.String fileid,long size,byte[] md5,int fileStatus,boolean updateStudyAccessTime,boolean clearExternalRetrieveAET,org.dcm4chex.archive.common.PatientMatching matching ) throws org.dcm4che.net.DcmServiceException, org.dcm4chex.archive.exceptions.NonUniquePatientIDException;

   public org.dcm4che.data.Dataset store( org.dcm4che.data.Dataset ds,long fspk,java.lang.String fileid,long size,byte[] md5,int fileStatus,boolean updateStudyAccessTime,boolean clearExternalRetrieveAET,org.dcm4chex.archive.common.PatientMatching matching,boolean canRollback ) throws org.dcm4che.net.DcmServiceException, org.dcm4chex.archive.exceptions.NonUniquePatientIDException;
   ...
   public void storeFile( java.lang.String iuid,java.lang.String tsuid,java.lang.String dirpath,java.lang.String fileid,int size,byte[] md5,int status ) throws javax.ejb.CreateException, javax.ejb.FinderException;
